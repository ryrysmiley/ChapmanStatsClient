...
export default function Insert() {
    const handlePlayer = async (event) =>{
        ...
        try{
            const res = await fetch('http://localhost:8800/addPlayer', {
                method: 'POST',
                mode: 'cors',
                headers: {
    ...
    const handleGame = async (event) =>{
        ...
        try{
            const res = await fetch('http://localhost:8800/addGame', {
                method: 'POST',
                mode: 'cors',
                headers: {
                    'Content-Type': 'application/json'
    ...
    const handleDrill = async (event) =>{
        ...
        try{
            const res = await fetch('http://localhost:8800/addDrill', {
                method: 'POST',
                mode: 'cors',
                headers: {
                    'Content-Type': 'application/json'
    ...
    const handleGameStats = async (event) =>{
        ...
        try{
            const res = await fetch('http://localhost:8800/addGameStats', {
                method: 'POST',
                mode: 'cors',
                headers: {
                    'Content-Type': 'application/json'
    ...
    const handleDrillStats = async (event) =>{
        ...
        try{
            const res = await fetch('http://localhost:8800/addDrillStats', {
                method: 'POST',
                mode: 'cors',
                headers: {
                    'Content-Type': 'application/json'
